...
<head>
    ...
    <title>Home of Modernist Kaunas | modernist.kaunas.lt</title>

    <meta name="description" content="Stories about interwar Kaunas, EHL and UNESCO world heritage titles, answers to 
    your questions and other relevant information. Visit and find out!">
    <meta name="keywords" content="unesco world heritage site, world heritage site, european heritage label, kaunas unesco, kaunas unesco heritage, kaunas interwar architecture unesco, kaunas interwar">
    ...
    <link href="src/css/style.css?v=21" rel="stylesheet">
...
<body>
    <header>
        <div class="desktop-nav container">
            ...
            <nav>
                <ul>
                    <li><a href="/en/unesco.php">Unesco</a></li>
                    <li><a href="/en/ehl.php">Ehl</a></li>
                    <li><a href="/en/gyventojams.php">For Residents</a></li>
                    <li><a href="/en/kontaktai.php">Contacts</a></li>
                </ul>
            </nav>
            <div class="socials">
                <a href="/">LT</a>
        ...
        <div class="mobile-dropdown">
            <ul>
                ...
                <li><a href="ehl.php">Ehl</a></li>
                <li><a href="gyventojams.php">For Residents</a></li>
